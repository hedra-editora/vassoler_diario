...
menor e sentenciaria: -- Eu sou aquela que tudo nega!
...
\begin{quote}
\textsc{Kolia:} Vamos, padre, me diga: onde está o seu Deus onipotente e
...
\begin{flushright}
\emph{A bordo do trem que vai de Samara a Volgogrado (Stalingrado),
02 de julho de 2018}
\end{flushright}
...
\begin{flushright}
\emph{A bordo do voo que vai de Sotchi a Kaliningrado (Königsberg),
10 de julho de 2018}
\end{flushright}
...
\begin{flushright}
\emph{A bordo do voo que vai de Kaliningrado (Königsberg) a São Petersburgo,
13 de julho de 2018}
\end{flushright}
